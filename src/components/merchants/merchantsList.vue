  ...
  <div class="merchantsList">
    ...
    <div class="title">
      <div class="nav clearfix">
        ...
        <h2 class="navTitle fl">招商</h2>
        <router-link :to="{path:'/shopSearch',query:{url:'merchantsList'}}"></router-link>
      </div>
      <div class="shaixuan">
        <div class="list">
            ...
            <li v-for="(item,index) in projectList" @click="go(item,index)">
              <div class="wrap">
                ...
                <div class="msg">
                  ...
                  <div class="price">平均租金：<span>{{item.price}}元/天/㎡</span></div>
    ...
    <div class="shopWrite" @click="fabuFun()">发布招商</div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fabuFun(){
        this.$router.push({path:"/publishCM",query:{url:"merchantsList"}})
      },
      backTopFun(){
      ...
      loadTop(){//下拉刷新
        ...
        var data = {
          ...
          pageSize: this.pageSize, //每页数据量【必传】
          pageNum: this.pageNum, //页码从1开始【必传】
          projectType: 2, //项目类型，1是销售，2是招商【必传】
          projectDistrictId: this.regionSelect, //区域筛选
          houseType: this.typeSelect, //建筑类型筛选
          beginPrice: this.beginpriceSelect, //价格段筛选
          endPrice: this.endpriceSelect, //价格段筛选
